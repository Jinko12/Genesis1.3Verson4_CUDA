...
#ifdef GENESIS_CUDA
   bool trackCuda(double, Beam *, Undulator *, bool, genesis_cuda::BeamState *, size_t npart);
   bool applyR56Cuda(Beam *, Undulator *, double, genesis_cuda::BeamState *, size_t npart);
#endif
